...
- (void)viewDidLoad {
    ...
    self.tableView.tableHeaderView=[[[NSBundle mainBundle] loadNibNamed:@"headershouyangTableViewCell" owner:nil options:nil] lastObject];
